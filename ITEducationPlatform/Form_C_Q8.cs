...
{
    public partial class Form_C_Q8 : UserControl
    {
        ...
        public Form_C_Q8()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(15, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(15, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(15, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(15, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(15, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(15, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 15, Correct = correct });

            string category = DataUtil.GetCategory(15);

            DataUtil.SaveRecord(GlobalService.User, category, 15, correct, GlobalService.Company);
