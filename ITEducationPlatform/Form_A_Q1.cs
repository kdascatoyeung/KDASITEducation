...
{
    public partial class Form_A_Q1 : UserControl
    {
        ...
        public Form_A_Q1()
        {
            ...
            lblQuestion.Text =  DataUtil.GetQuestion(1, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(1, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(1, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(1, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(1, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(1, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 1, Correct = correct });

            string category = DataUtil.GetCategory(1);

            DataUtil.SaveRecord(GlobalService.User, category, 1, correct, GlobalService.Company);
