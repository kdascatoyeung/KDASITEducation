...
{
    public partial class Form_B_Q1 : UserControl
    {
        ...
        public Form_B_Q1()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(4, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(4, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(4, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(4, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(4, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(4, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 4, Correct = correct });

            string category = DataUtil.GetCategory(4);

            DataUtil.SaveRecord(GlobalService.User, category, 4, correct, GlobalService.Company);
