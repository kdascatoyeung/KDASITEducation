...
{
    public partial class Form_C_Q13 : UserControl
    {
        ...
        public Form_C_Q13()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(20, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(20, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(20, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(20, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(20, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(20, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 20, Correct = correct });

            string category = DataUtil.GetCategory(20);

            DataUtil.SaveRecord(GlobalService.User, category, 20, correct, GlobalService.Company);
