...
{
    public partial class Form_C_Q7 : UserControl
    {
        ...
        public Form_C_Q7()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(14, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(14, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(14, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(14, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(14, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(14, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 14, Correct = correct });

            string category = DataUtil.GetCategory(14);

            DataUtil.SaveRecord(GlobalService.User, category, 14, correct, GlobalService.Company);
