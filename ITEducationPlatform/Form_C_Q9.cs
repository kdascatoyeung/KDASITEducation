...
{
    public partial class Form_C_Q9 : UserControl
    {
        ...
        public Form_C_Q9()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(16, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(16, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(16, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(16, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(16, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(16, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 16, Correct = correct });

            string category = DataUtil.GetCategory(16);

            DataUtil.SaveRecord(GlobalService.User, category, 16, correct, GlobalService.Company);
