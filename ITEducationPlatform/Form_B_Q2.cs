...
{
    public partial class Form_B_Q2 : UserControl
    {
        ...
        public Form_B_Q2()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(5, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(5, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(5, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(5, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(5, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(5, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 5, Correct = correct });

            string category = DataUtil.GetCategory(5);

            DataUtil.SaveRecord(GlobalService.User, category, 5, correct, GlobalService.Company);
