...
{
    public partial class Form_A_Q3 : UserControl
    {
        ...
        public Form_A_Q3()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(3, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(3, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(3, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(3, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(3, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(3, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 3, Correct = correct });

            string category = DataUtil.GetCategory(3);

            DataUtil.SaveRecord(GlobalService.User, category, 3, correct, GlobalService.Company);
