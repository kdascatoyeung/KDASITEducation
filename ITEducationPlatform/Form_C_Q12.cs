...
{
    public partial class Form_C_Q12 : UserControl
    {
        ...
        public Form_C_Q12()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(19, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(19, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(19, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(19, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(19, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(19, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 19, Correct = correct });

            string category = DataUtil.GetCategory(19);

            DataUtil.SaveRecord(GlobalService.User, category, 19, correct, GlobalService.Company);
