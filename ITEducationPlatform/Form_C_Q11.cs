...
{
    public partial class Form_C_Q11 : UserControl
    {
        ...
        public Form_C_Q11()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(18, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(18, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(18, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(18, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(18, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(18, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 18, Correct = correct });

            string category = DataUtil.GetCategory(18);

            DataUtil.SaveRecord(GlobalService.User, category, 18, correct, GlobalService.Company);
