...
{
    public partial class Form_C_Q2 : UserControl
    {
        ...
        public Form_C_Q2()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(9, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(9, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(9, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(9, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(9, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(9, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 9, Correct = correct });

            string category = DataUtil.GetCategory(9);

            DataUtil.SaveRecord(GlobalService.User, category, 9, correct, GlobalService.Company);
