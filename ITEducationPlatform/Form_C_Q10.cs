...
{
    public partial class Form_C_Q10 : UserControl
    {
        ...
        public Form_C_Q10()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(17, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(17, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(17, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(17, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(17, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(17, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 17, Correct = correct });

            string category = DataUtil.GetCategory(17);

            DataUtil.SaveRecord(GlobalService.User, category, 17, correct, GlobalService.Company);
