...
{
    public partial class Form_C_Q3 : UserControl
    {
        ...
        public Form_C_Q3()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(10, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(10, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(10, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(10, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(10, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(10, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 10, Correct = correct });

            string category = DataUtil.GetCategory(10);

            DataUtil.SaveRecord(GlobalService.User, category, 10, correct, GlobalService.Company);
