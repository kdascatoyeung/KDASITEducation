...
{
    public partial class Form_A_Q2 : UserControl
    {
        ...
        public Form_A_Q2()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(2, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(2, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(2, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(2, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(2, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(2, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 2, Correct = correct });

            string category = DataUtil.GetCategory(2);

            DataUtil.SaveRecord(GlobalService.User, category, 2, correct, GlobalService.Company);
