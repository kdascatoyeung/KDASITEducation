...
{
    public partial class Form_C_Q6 : UserControl
    {
        ...
        public Form_C_Q6()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(13, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(13, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(13, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(13, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(13, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(13, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 13, Correct = correct });

            string category = DataUtil.GetCategory(13);

            DataUtil.SaveRecord(GlobalService.User, category, 13, correct, GlobalService.Company);
