...
{
    public partial class Form_C_Q5 : UserControl
    {
        ...
        public Form_C_Q5()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(12, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(12, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(12, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(12, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(12, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(12, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 12, Correct = correct });

            string category = DataUtil.GetCategory(12);

            DataUtil.SaveRecord(GlobalService.User, category, 12, correct, GlobalService.Company);
