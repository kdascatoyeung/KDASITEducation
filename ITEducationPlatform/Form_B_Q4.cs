...
{
    public partial class Form_B_Q4 : UserControl
    {
        ...
        public Form_B_Q4()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(7, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(7, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(7, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(7, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(7, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(7, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 7, Correct = correct });

            string category = DataUtil.GetCategory(7);

            DataUtil.SaveRecord(GlobalService.User, category, 7, correct, GlobalService.Company);
