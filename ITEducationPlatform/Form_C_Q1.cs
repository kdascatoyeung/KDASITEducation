...
{
    public partial class Form_C_Q1 : UserControl
    {
        ...
        public Form_C_Q1()
        {
            ...
            lblQuestion.Text = DataUtil.GetQuestion(8, GlobalService.Mode);

            List<string> answerList = DataUtil.GetAnswerList(8, GlobalService.Mode, 4);
            answerList.Shuffle();
        ...
        {
            if (!DataUtil.IsAnswerCorrect(8, ckbAns1.Text.Trim(), GlobalService.Mode, ckbAns1.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(8, ckbAns2.Text.Trim(), GlobalService.Mode, ckbAns2.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(8, ckbAns3.Text.Trim(), GlobalService.Mode, ckbAns3.Checked))
            {
            ...
            if (!DataUtil.IsAnswerCorrect(8, ckbAns4.Text.Trim(), GlobalService.Mode, ckbAns4.Checked))
            {
            ...
            GlobalService.RecordList.Add(new RecordList { User = GlobalService.User, QuestionId = 8, Correct = correct });

            string category = DataUtil.GetCategory(8);

            DataUtil.SaveRecord(GlobalService.User, category, 8, correct, GlobalService.Company);
